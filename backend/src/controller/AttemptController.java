...
public class AttemptController {
    ...
    public ResponseEntity<?> submitDirect(@RequestBody Map<String, Object> payload) {
        ...
        try {
            ...
            Integer totalQuestions = (Integer) payload.getOrDefault("totalQuestions", 0);

            Integer correctAnswers = (Integer) payload.getOrDefault("correctAnswers", 0);

            Integer totalMarks = (Integer) payload.getOrDefault("totalMarks", 100);
